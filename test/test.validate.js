...
describe( 'validate', function tests() {
	...
	it( 'should return an error if provided a `d1` parameter which is not a positive number', function test() {
		var values, err;
		 values = [
			-2,
			0,
...
it( 'should return an error if provided a `d2` parameter which is not a positive number', function test() {
		var values, err;
		 values = [
			-2,
			0,
